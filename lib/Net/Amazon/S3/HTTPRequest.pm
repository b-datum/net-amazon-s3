...
sub query_string_authentication_uri {
  ...
  $canonical_string.= '?response-content-disposition=' . $content_disposition
  ...
  $uri->query_param( 'response-content-disposition' => $content_disposition);
  return $uri;
}
...
sub _canonical_string {
  my ( $self, $method, $path, $headers, $expires, $disposition ) = @_;
